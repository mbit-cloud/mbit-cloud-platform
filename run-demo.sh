...
docker run --name $NAME -d -p 3105:8888 -t boostrack/debian:nucleos-eureka-server
...
docker run --name $NAME -d -p 3110:8761 -t boostrack/debian:microservices-account
