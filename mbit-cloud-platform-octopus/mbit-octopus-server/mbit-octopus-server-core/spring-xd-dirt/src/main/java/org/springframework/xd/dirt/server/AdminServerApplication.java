...
@ImportResource({
	"classpath:" + ConfigLocations.XD_INTERNAL_CONFIG_ROOT + "admin-server.xml",
	"classpath*:/META-INF/spring/batch/**/*.xml"
	})

@Import(RestConfiguration.class)
//@ComponentScan( basePackages = {"org.springframework.batch.admin" })
