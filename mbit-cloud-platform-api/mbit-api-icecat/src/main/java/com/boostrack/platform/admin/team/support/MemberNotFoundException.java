 ...
 * {@link com.boostrack.platform.admin.MvcConfig.ErrorConfig} for details, and contrast the approach used here
 * with {@link com.boostrack.platform.admin.MvcConfig#handleException(sagan.support.ResourceNotFoundException)}
 */
